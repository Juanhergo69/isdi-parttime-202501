...
import { createContainer, createTextContainer, createButton, createImgButton, createForm, createHomePage } from './3containers.mjs' //Importamos todos los creadores de contenedores//
import { registerUser, loginUser, viewMessages } from './4data.mjs' //Importamos las funciones de registro y logueo//
