...
import { renderLandingPage, renderRegisterPage, renderLoginpage } from './5rendered.mjs' //Importamos todas las funciones que impliquen renderizados//
import { createHomePage } from './3containers.mjs' //Importamos funcion createHomePage (vinculada a la navegación a Home)//
...
export const navigateToHome = () => navigateTo(createHomePage) //Exportamos y creamos navigateToHome, asignando hacia donde navegamos (createHomePage)//
//**********************************************************************************************************************************************************************************************//
//**********************************************************************************************************************************************************************************************//