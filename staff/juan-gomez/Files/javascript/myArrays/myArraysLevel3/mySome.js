//Método Some//
//El metodo some itera los elementos de un array y pasa un callback. Si alguno de los elementos iterados cumple la función del callback, devolvería true. Si no cumple ningún elemento con el callback, devolvería false//
...
//***************************************************************************************************************************************************************//
//DECLARAMOS UNA FUNCIÓN QUE REALIZARÍA, DE MANERA MANUAL, EL MÉTODO SOME//
const mySome = (array, callback) => { //La función permitiría realizar un some sobre un array, aplicando un callback sobre cada elemento de ese array, para comprobar si alguno de ellos cumple con el//
    ...
    return false //Si no hay ningún elemento que pase el callback, devolvemos false//
}
...
const controlResult1 = testNames.some((name) => { //Declaramos la primera variable de control, donde aplicaremos el some sobre el array original, con el callback a ejecutar (en este caso, devolver si algún elemento empieza por la letra 'S'. Devolvería true, ya que hay un elemento en el array que empieza por 'S'//
    return name.startsWith('S')
})
const controlResult2 = mySome(names, (name) => { //Declaramos la segunda variable de control, donde aplicaremos el some sobre el array original, con el callback a ejecutar (en este caso, devolver si algún elemento empieza por la letra 'S'). Devolvería true, ya que hay un elemento en el array que empieza por 'S'//
    return name.startsWith('S')
})
//***************************************************************************************************************************************************************//
...
console.log(controlResult1) //Devuelve en consola true, ya que hay un elemento en el array que empieza por 'S'//
console.log(controlResult2) //Devuelve en consola true, ya que hay un elemento en el array que empieza por 'S'//
//***************************************************************************************************************************************************************//