...
function myJoin(separator, array) { //La función realizaría un join de forma manual, en base a un array y un elemento separador//
    ...
    var join = '' //Declaramos variable join, que almacenará cada espacio entre elementos del array//
...
var controlResult1 = testNames.join('+') //Declaramos primera variable de control, donde realizamos el join sobre el array de testeo, con el elemento separador a introducir. Devolvería el array en un string, con todos los elementos separados con un '+'//
var controlResult2 = myJoin('+', names) //Declaramos la segunda variable de control, donde aplicaremos el join sobre el array original, con el elemento separador a introducir, a través de nuestra función manual. Devolvería el array en un string, con todos los elementos separados con un '+'//
//***************************************************************************************************************************************************************//
