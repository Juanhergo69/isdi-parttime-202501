...
function mySlice(array, firstindex, lastindex) { //La función realizaría un slice de forma manual, en base a un array y un primer índice de extracción y un segundo índice de extracción(los elementos entre los dos índices serán los que se extraerán)//
...
var controlResult1 = testNames.slice(1, 3) //Declaramos primera variable de control, donde realizamos el slice sobre el array de testeo, con el índice de posiciones de las extracciones a realizar. Devolvería un array con los nombres 'Diana' y 'Sonia'//
var controlResult2 = mySlice(names, 1, 3) //Declaramos la segunda variable de control, donde aplicaremos el slice sobre el array original, con el índice de posiciones de las extracciones a realizar, a través de nuestra función manual. Devolvería un array con los nombres 'Diana' y 'Sonia//
//***************************************************************************************************************************************************************//
