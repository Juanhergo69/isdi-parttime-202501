...
const myIncludes = (array, element) => { //La función realizaría un includes de forma manual, en base a un array y un elemento a rastrear//
...
const controlResult1 = testNames.includes('Juan') //Declaramos primera variable de control, donde realizamos el includes sobre el array de testeo, con el elemento a rastrear. Devolvería un booleano, en este caso true, dado que el elemento a rastrear 'Juan', se encuentra dentro del array de testeo//
const controlResult2 = myIncludes(names, 'Juan') //Declaramos la segunda variable de control, donde aplicaremos el includes sobre el array original, con el elemento a rastrear, a través de nuestra función manual. Devolvería un booleano, en este caso true, dado que el elemento a rastrear 'Juan', se encuentra dentro del array original//
//***************************************************************************************************************************************************************//
