...
const myShift = (array) => { //La función realizaría un shift de forma manual, sobre un array//
    ...
    let shift = array[0] //Declaramos la variable shift, que contendrá el primer elemento del array//
...
const controlResult1 = testNames.shift() //Declaramos primera variable de control, donde realizamos el shift sobre el array de testeo. Devolvería el elemento que hemos eliminado del array de test, en este caso, la palabra Juan//
const controlResult2 = myShift(names) //Declaramos la segunda variable de control, donde aplicaremos el shift sobre el array original, a través de nuestra función manual. Devolvería el elemento que hemos eliminado del array original, en este caso, la palabra Juan//
//***************************************************************************************************************************************************************//
