...
const myIndexOf = (array, element) => { //La función realizaría un indexOf de forma manual, en base a un array y un elemento a rastrear//
    ...
    for (let i = 0; i < array.length; i++) { //El for itera los elementos del array//
...
const controlResult1 = testNames.indexOf('Juan') //Declaramos primera variable de control, donde realizamos el indexOf sobre el array de testeo, con el elemento a rastrear. Devolvería la posición 0, dado que el elemento a rastrear 'Juan', se encuentra dentro del array de testeo//
const controlResult2 = myIndexOf(names, 'Juan') //Declaramos la segunda variable de control, donde aplicaremos el indexOf sobre el array original, con el elemento a rastrear, a través de nuestra función manual. Devolvería la posición 0, dado que el elemento a rastrear 'Juan', se encuentra dentro del array original//
//***************************************************************************************************************************************************************//
