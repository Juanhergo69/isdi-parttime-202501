...
let names = ['Juan', 'Diana', 'Sonia', 'Marta', 'Juan'] //Declaramos variable con array original//
let testNames = ['Juan', 'Diana', 'Sonia', 'Marta', 'Juan'] //Declaramos variable de test con los elementos del array original//
//**************************************************************************************************************************************************************//

//***************************************************************************************************************************************************************//
//DECLARAMOS UNA FUNCIÓN QUE REALIZARÍA, DE MANERA MANUAL, EL MÉTODO LASTINDEXOF//
const mylastIndexOf = (array, element) => { //La función realizaría un lastIndexOf de forma manual, en base a un array y un elemento a rastrear//
    ...
    for (let i = array.length - 1; i >= 0; i--) { //El for itera los elementos del array a la inversa, empezando a iterarlos desde la última posición hasta la primera posición//
