...
let names2 = ['Juanjo', 'Francisco', 'David', 'Marco'] //Declaramos variable con el array que queremos concatenar//
let testNames = ['Juan', 'Diana', 'Sonia', 'Marta'] //Declaramos variable de test con los elementos del array original//
let testNames2 = ['Juanjo', 'Francisco', 'David', 'Marco'] //Declaramos variable de test con los elementos del array que queremos concatenar//
//**************************************************************************************************************************************************************//

//***************************************************************************************************************************************************************//
//DECLARAMOS UNA FUNCIÓN QUE REALIZARÍA, DE MANERA MANUAL, EL MÉTODO CONCAT//
const myConcat = (array1, array2) => { //La función realizaría un concat de forma manual, añadiendo los elementos de un array a otro//
    ...
    for (let i = 0; i < array1.length; i++) { //El for itera los elementos del array1//
    ...
    for (let j = 0; j < array2.length; j++) { //El for itera los elementos del array2. Iteramos con un índice diferente, para que ambos array se almacenen de forma independiente//
...
const controlResult1 = testNames.concat(testNames2) //Declaramos primera variable de control, donde realizamos el concat de testeo sobre el array de testeo. Devolvería el array concatenado por orden (primero testNames y a continuación testNames2//
const controlResult2 = myConcat(names, names2) //Declaramos la segunda variable de control, donde aplicaremos el concat original sobre el array original, a través de nuestra función manual. Devolvería el array concatenado por orden (primero names y a continuación names2//
//***************************************************************************************************************************************************************//
