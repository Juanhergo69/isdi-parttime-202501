...
var nameToPush = 'Copito' //Declaramos variable de aquello que queremos añadir sobre nuestro array con el método push//
//**************************************************************************************************************************************************************//

//***************************************************************************************************************************************************************//
//DECLARAMOS UNA FUNCIÓN QUE REALIZARÍA, DE MANERA MANUAL, EL MÉTODO PUSH//
function myPush(array, elementToPush) { //La función realizaría un push de forma manual, sobre un array, indicando el elemento que se quiera añadir//
...
var controlResult1 = testNames.push(nameToPush) //Declaramos primera variable de control, donde realizamos el push de aquello que queremos añadir, sobre el array de testeo. Devolvería la longitud del array//
var controlResult2 = myPush(names, nameToPush) //Declaramos la segunda variable de control, donde aplicaremos el push sobre el array original, a través de nuestra función manual. Devolvería el elemento que hemos añadido al array original, en este caso, la palabra Copito//
//***************************************************************************************************************************************************************//
