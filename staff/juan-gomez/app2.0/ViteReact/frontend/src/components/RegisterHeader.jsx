...
//Define el componente funcional RegisterHeader que recibe la prop navigateToLanding//
const RegisterHeader = ({ navigateToLanding }) => {
  ...
  return (
    ...
    <>
      ...
      <Link
        ...
        className="registerImgButton"  //Clase CSS para estilizar el contenedor del logo//
      ...
      >
        ...
        <img 
          src="/Logo.jpg"  //Ruta de la imagen del logo (debería estar en la carpeta public)//
          alt="Home"  //Texto alternativo para accesibilidad (describe la función del botón)//
        />
      </Link>
      
      {/* Título principal de la página de registro */}
      <h1 className="registerTitle">REGISTER</h1>  {/*Texto del título con clase para estilizado*/}
    </>
  )
}
